...
public interface UserControllerDocs {
    ...
    ResponseEntity<Object> getUserInformations(HttpServletRequest request);
    ...
    @SecurityRequirement(name = "jwt_auth")
    ResponseEntity<Object> update(HttpServletRequest request, @RequestBody UserEntity userEntity);
    ...
    @SecurityRequirement(name = "jwt_auth")
    ResponseEntity<Object> delete(HttpServletRequest request);
